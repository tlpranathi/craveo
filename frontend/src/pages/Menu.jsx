                ...
                <div className="flex-shrink-0">
                  {qty === 0 ? (
                    <button
                      ...
                      className="bg-craveo-500 hover:bg-craveo-600 text-white px-5 py-2 rounded-lg font-medium transition whitespace-nowrap"
                    >
                      Add
                    </button>
                  ) : (
                    <div className="flex items-center gap-3 bg-craveo-50 rounded-lg px-2 py-1.5">
                      <button
                        ...
                        className="w-7 h-7 flex items-center justify-center text-craveo-600 font-bold hover:bg-craveo-100 rounded-md transition"
                      >
                        −
                      </button>
